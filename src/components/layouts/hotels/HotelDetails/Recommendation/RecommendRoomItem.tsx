...
import { differenceInCalendarDays, format, isWithinInterval, startOfDay } from 'date-fns';
...
interface RecommendRoomItemProps {
  hotel: HotelSchema;
  room: RoomSchema;
...
export default function RecommendRoomItem({ room, hotel, canBook = false, date }: RecommendRoomItemProps) {
            ...
            <div>
              ...
              >
                ...
                {date?.from ? (
                  ...
                  <span>{t('footer.selectDateTitle')}</span>
                )}
              </Button>
            </div>
            {/* Breakfast include? */}
